...
BASE_SCRIPTS = [
    'example_test_p2ms.py',
    'example_test_p2pk.py',
    'example_test_p2pkh.py',
    'example_test_p2sh_individual.py',
    'example_test_p2sh_musig.py',
    'example_test_p2sh_p2wpkh.py',
    'example_test_p2sh_p2wsh_individual.py',
    'example_test_p2sh_p2wsh_musig.py',
    'example_test_p2wpkh.py',
    'example_test_p2wsh_individual.py',
    'example_test_p2wsh_musig.py',
    ]
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, use_term_control):
    ...
    tests_dir = src_dir# + '/test_bitcoin_test_framework/'#'/test/functional/'
