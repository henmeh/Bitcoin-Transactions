...
from src.script import Script, p2pk_script, p2sh_script, p2ms_script
from src.crypto import hash160

class P2SHTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        bob_spending_transaction.sign_transaction(0, [bob_wallet_1["wallet_private_key_int"], charlie_wallet_1["wallet_private_key_int"]], bob_script_sig, 2, 2, bob_and_charlie_skript)
