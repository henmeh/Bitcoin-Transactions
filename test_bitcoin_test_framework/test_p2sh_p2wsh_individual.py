...
class P2SHTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        transaction_input = CTxIn(bytes.fromhex(bob_previous_tx_id_to_spent), bob_previous_tx_index_to_spent, script_sig=Script([bytes.fromhex(bob_original_p2wsh_script.serialize_script().hex()[2:])]), witness=bob_script_sig.commands)
