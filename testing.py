...
def test_schnorr_musig_attack():
    random_number_1 = 123456789
    key_private_1 = 12345678987654321
    key_public_1 = curve.ec_multiply(key_private_1)
    R1 = curve.ec_multiply(random_number_1)

    #attacker
    random_number_2 = 123456427
    ...
    R2 = curve.ec_multiply(random_number_2)
    inverse_R1 = (R1[0], (p-R1[1]))
    R2_prime = curve.ec_addition(R2, inverse_R1)

    added_keys_public = curve.ec_addition(key_public_1, key_public_2_prime)
    added_r_values = curve.ec_addition(R1, R2_prime)
